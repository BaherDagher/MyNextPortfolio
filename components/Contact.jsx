...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c54466b1-b4e4-4ffb-a5e2-ed557e246d9f");
  ...
  return (
    <motion.div
      ...
      id='contact' className='w-11/12 mx-auto py-10 scroll-mt-20 md:w-full md:px-[12%] bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      <motion.p
        ...
        <br /> Please use the form below.</motion.p>
      ...
      <motion.form
        ...
        <motion.button
          ...
          type='submit'
          className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black text-white rounded-full mx-auto hover:border-black  duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'
