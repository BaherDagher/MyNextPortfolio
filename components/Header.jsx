  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      >
        ...
        <div className="w-36 h-36 rounded-full overflow-hidden bg-gray-100 relative">
          <Image
      ...
      <motion.p
        ...
        Passionate about crafting clean, interactive, and user-focused web experiences.
      </motion.p>
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        <motion.a
          ...
          href="#contact"
          className='w-40 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent justify-center'
